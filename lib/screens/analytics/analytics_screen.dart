          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Automated color-coded segregation by MediBot R-01',
                  style: TextStyle(
                    fontSize: 11,
                    color: isDark ? AppConstants.lightSlate : AppConstants.neutralGrey,
                  ),
                ...
                _categoryShareRow('Infectious / Yellow Bin', 19.60, 0.53, AppConstants.infectiousColor),
                _categoryShareRow('Contaminated Plastic / Red Bin', 9.68, 0.26, AppConstants.plasticColor),
                _categoryShareRow('Sharps & Blades / White Bin', 3.94, 0.11, AppConstants.sharpsAccent),
                _categoryShareRow('Glassware & Other / Blue Bin', 3.67, 0.10, AppConstants.otherColor),
              ],
            ),
          ),
